...
依据[官方](http://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D)说明文档, 这是和单选框不同之处:
...
需要了解更多有关复选框的信息，请关注 [Angular 复选框](http://docs.angularjs.org/api/ng/input/input%5Bcheckbox%5D)说明文档.
...
据[官方文档](http://docs.angularjs.org/api/ng/input/input%5Bradio%5D), 这是提供的选项:
...
更多内容，请阅读[Angular 单选](http://docs.angularjs.org/api/ng/input/input%5Bradio%5D)按钮文档.
