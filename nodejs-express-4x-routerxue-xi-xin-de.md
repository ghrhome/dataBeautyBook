...
测试：[http://127.0.0.1:3000/login/result1?var=tom](http://127.0.0.1:3000/login/result1?var=tom)

结果

![](http://doc.okbase.net/picture/addon/2015/01/29/A090928200-126298.png)

测试：[http://127.0.0.1:3000/login/result2?var=tom2](http://127.0.0.1:3000/login/result2?var=tom2)
...
[http://127.0.0.1:3000/user/:id方式，router对象的param方法用于路径参数的处理](http://127.0.0.1:3000/user/:id方式，router对象的param方法用于路径参数的处理)
...
测试：[http://127.0.0.1:3000/user/tom](http://127.0.0.1:3000/user/tom)
